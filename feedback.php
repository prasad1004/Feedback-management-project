...
$query = mysqli_query($con, "INSERT INTO `poll`(`id`, `name`, `email`, `phone`, `customer feedback`, `product feedback`, `price feedback`, `suggestions`) VALUES ('','$name','$email','$num','$view','$view','$view','$comments')");
